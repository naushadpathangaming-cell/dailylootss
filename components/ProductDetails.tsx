      ...
      <main className="max-w-6xl mx-auto py-12 px-6">
        <div className="grid md:grid-cols-2 gap-10">
          ...
          <div>
            ...
            {/* BUY NOW - NOW DIRECTLY UNDER PRICE */}
            <button
              onClick={() => {
                window.location.href =
                  "https://rzp.io/rzp/nexoraaistore";
              }}
              className="mt-5 w-full bg-indigo-600 text-white py-4 rounded-xl text-lg font-bold hover:bg-indigo-700 transition"
            >
              🛒 Buy Now
            </button>
